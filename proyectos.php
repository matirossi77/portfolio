    ...
    <div class="row">
      <div class="col-12 col-sm-4 p-3">
        <div class="proyecto">
          ...
          <p class="p-3 pb-5 d-block">
            Alta, baja y modificación de un registro de clientes. Realizado en
          ...
          <div class="row my-5">
            ...
            <div class="col-6 text-center">
              <a href="" target="_blank" class="btn codigo-fuente">Código fuente</a>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="col-12 col-sm-4 p-3">
        <div class="proyecto">
          ...
          <p class="p-3 pb-5 d-block">
            ...
            jQuery, AJAX, HTML, CSS, Mercadopago con panel administrador,
            gestor de usuarios, módulo de permisos y funcionalidades a fines.
          </p>
          <div class="row my-5">
            <div class="col-6 ps-4">
              <a href="" target="_blank" class="btn btn-rojo">Ver online</a>
